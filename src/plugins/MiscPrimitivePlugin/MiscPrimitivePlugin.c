/* Automatically generated by
   ...
   from
	MiscPrimitivePlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38
	Bitmap Graphics-Primitives-MarcusDenker.138 uuid: e8cbfe45-3555-4636-bf86-5cbce9df0fc2
	ByteArray Collections-Arrayed-EstebanLorenzano.69 uuid: 18c34aba-8639-4cee-9a8f-fe44344ada54
	ByteString Collections-Strings-MarcusDenker.308 uuid: 558a2bab-d62b-49b7-9695-0e0a59977f2f
	SampledSound Sound-GuillermoPolito.69 uuid: ab9cfd18-4610-4306-ae3d-5b258f0baed3
	String Collections-Strings-MarcusDenker.308 uuid: 558a2bab-d62b-49b7-9695-0e0a59977f2f
 */
static char __buildInfo[] = "MiscPrimitivePlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38\n\
Bitmap Graphics-Primitives-MarcusDenker.138 uuid: e8cbfe45-3555-4636-bf86-5cbce9df0fc2\n\
ByteArray Collections-Arrayed-EstebanLorenzano.69 uuid: 18c34aba-8639-4cee-9a8f-fe44344ada54\n\
ByteString Collections-Strings-MarcusDenker.308 uuid: 558a2bab-d62b-49b7-9695-0e0a59977f2f\n\
SampledSound Sound-GuillermoPolito.69 uuid: ab9cfd18-4610-4306-ae3d-5b258f0baed3\n\
String Collections-Strings-MarcusDenker.308 uuid: 558a2bab-d62b-49b7-9695-0e0a59977f2f " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"MiscPrimitivePlugin VMMaker.oscog-jeanbaptistearnaud.782 (i)"
#else
	"MiscPrimitivePlugin VMMaker.oscog-jeanbaptistearnaud.782 (e)"
#endif
;
	...
	while (k <= size) {
		...
		if (j > k) {
			...
			if (eqBytes) {
				...
				/* begin encodeBytesOf:in:at: */
				for (j3 = 0; j3 <= 3; j3 += 1) {
					ba[(i + 1) + j3] = ((((usqInt) ((((j - k) + 1) * 4) + 1)) >> ((3 - j3) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
			l1:	/* end encodeInt:in:at: */;
				...
				/* begin encodeBytesOf:in:at: */
				for (j4 = 0; j4 <= 3; j4 += 1) {
					ba[(i + 1) + j4] = ((((usqInt) ((((j - k) + 1) * 4) + 2)) >> ((3 - j4) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
			l2:	/* end encodeInt:in:at: */;
				/* begin encodeBytesOf:in:at: */
				for (j1 = 0; j1 <= 3; j1 += 1) {
					ba[i + j1] = ((((usqInt) word) >> ((3 - j1) * 8)) & 0xFF);
				}
				i += 4;
			}
			k = j + 1;
			...
			if (eqBytes) {
				...
				/* begin encodeBytesOf:in:at: */
				for (j5 = 0; j5 <= 3; j5 += 1) {
					ba[(i + 1) + j5] = ((((usqInt) ((1 * 4) + 1)) >> ((3 - j5) * 8)) & 0xFF);
				}
				i = (i + 1) + 4;
			...
			l4:	/* end encodeInt:in:at: */;
				for (m = k; m < j; m += 1) {
					/* begin encodeBytesOf:in:at: */
					for (j2 = 0; j2 <= 3; j2 += 1) {
						ba[i + j2] = ((((usqInt) (bm[m])) >> ((3 - j2) * 8)) & 0xFF);
					}
					i += 4;
				}
				k = j;
...
void* MiscPrimitivePlugin_exports[][3] = {
	...
	{"MiscPrimitivePlugin", "primitiveStringHash\000\000", (void*)primitiveStringHash},
	{"MiscPrimitivePlugin", "primitiveTranslateStringWithTable\000\000", (void*)primitiveTranslateStringWithTable},

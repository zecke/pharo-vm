/* Automatically generated by
   ...
   from
	FilePlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38
 */
static char __buildInfo[] = "FilePlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38 " __DATE__ ;
...
static sqInt makeDirEntryNamesizecreateDatemodDateisDirfileSizeposixPermissions(char *entryName, sqInt entryNameSize, sqInt createDate, sqInt modifiedDate, sqInt dirFlag, squeakFileOffsetType  fileSize, sqInt posixPermissions);
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"FilePlugin VMMaker.oscog-jeanbaptistearnaud.782 (i)"
#else
	"FilePlugin VMMaker.oscog-jeanbaptistearnaud.782 (e)"
#endif
;
static void * sCCPfn;
static void * sCDFfn;
...
static sqInt
makeDirEntryNamesizecreateDatemodDateisDirfileSizeposixPermissions(char *entryName, sqInt entryNameSize, sqInt createDate, sqInt modifiedDate, sqInt dirFlag, squeakFileOffsetType  fileSize, sqInt posixPermissions)
{
	// FilePlugin>>#makeDirEntryName:size:createDate:modDate:isDir:fileSize:posixPermissions:
    sqInt createDateOop;
    sqInt fileSizeOop;
    sqInt i;
    sqInt modDateOop;
	...
	pushRemappableOop(instantiateClassindexableSize(classArray(), 6));

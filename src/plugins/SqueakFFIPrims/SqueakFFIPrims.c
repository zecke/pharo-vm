/* Automatically generated by
	VMPluginCodeGenerator VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38
   from
	ThreadedIA32FFIPlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38
 */
static char __buildInfo[] = "ThreadedIA32FFIPlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"SqueakFFIPrims VMMaker.oscog-jeanbaptistearnaud.782 (i)"
#else
	"SqueakFFIPrims VMMaker.oscog-jeanbaptistearnaud.782 (e)"
#endif
;
...
return fetchPointerofObject(retVal & 0xFF, characterTable());
	}
}
...
l2:	/* end ffiLoadCalloutModule: */;
	...
	functionLength = byteSizeOf(functionName);
	address = ioLoadSymbolOfLengthFromModule(((int) (firstIndexableField(functionName))), functionLength, moduleHandle);
	if ((failed())
	 || (address == 0)) {
...
floatRet1 = dispatchFunctionPointer(((double (*)()) address1));
	}
	else {
intRet1 = dispatchFunctionPointer(((usqLong (*)()) address1));
	}
...
void* SqueakFFIPrims_exports[][3] = {
	...
	{"SqueakFFIPrims", "primitiveCallout\000\002", (void*)primitiveCallout},
	{"SqueakFFIPrims", "primitiveCalloutWithArgs\000\004", (void*)primitiveCalloutWithArgs},
	{"SqueakFFIPrims", "primitiveCreateManualSurface\000\000", (void*)primitiveCreateManualSurface},
	{"SqueakFFIPrims", "primitiveDestroyManualSurface\000\000", (void*)primitiveDestroyManualSurface},
	{"SqueakFFIPrims", "primitiveFFIAllocate\000\001", (void*)primitiveFFIAllocate},
	{"SqueakFFIPrims", "primitiveFFIDoubleAt\000\001", (void*)primitiveFFIDoubleAt},
	{"SqueakFFIPrims", "primitiveFFIDoubleAtPut\000\001", (void*)primitiveFFIDoubleAtPut},
	{"SqueakFFIPrims", "primitiveFFIFloatAt\000\001", (void*)primitiveFFIFloatAt},
	{"SqueakFFIPrims", "primitiveFFIFloatAtPut\000\001", (void*)primitiveFFIFloatAtPut},
	{"SqueakFFIPrims", "primitiveFFIFree\000\001", (void*)primitiveFFIFree},
	{"SqueakFFIPrims", "primitiveFFIGetLastError\000\377", (void*)primitiveFFIGetLastError},
	{"SqueakFFIPrims", "primitiveFFIIntegerAt\000\001", (void*)primitiveFFIIntegerAt},
	{"SqueakFFIPrims", "primitiveFFIIntegerAtPut\000\001", (void*)primitiveFFIIntegerAtPut},
	{"SqueakFFIPrims", "primitiveForceLoad\000\002", (void*)primitiveForceLoad},
	{"SqueakFFIPrims", "primitiveLogCallsTo\000\000", (void*)primitiveLogCallsTo},
	{"SqueakFFIPrims", "primitiveSetManualSurfacePointer\000\000", (void*)primitiveSetManualSurfacePointer},

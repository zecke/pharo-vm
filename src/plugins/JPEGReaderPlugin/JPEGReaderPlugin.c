/* Automatically generated by
   ...
   from
	JPEGReaderPlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38
 */
static char __buildInfo[] = "JPEGReaderPlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"JPEGReaderPlugin VMMaker.oscog-jeanbaptistearnaud.782 (i)"
#else
	"JPEGReaderPlugin VMMaker.oscog-jeanbaptistearnaud.782 (e)"
#endif
;
...
yComponent[CurrentXIndex] = 0;
		...
		y = ((y < 1) ? 1 : y);
		jpegBits[i] = (((0xFF000000UL + (y << 16)) + (y << 8)) + y);
	}
}
...
crComponent[CurrentXIndex] = 0;
		...
		blue = ((blue < 1) ? 1 : blue);
		jpegBits[i] = (((0xFF000000UL + (((usqInt) red << 16))) + (((usqInt) green << 8))) + blue);
	}
}
...
if (!((methodArgumentCount()) == 5)) {
	...
	if (!((slotSizeOf(arrayOop)) == DCTSize2)) {
		return primitiveFail();
	}
...
void* JPEGReaderPlugin_exports[][3] = {
	...
	{"JPEGReaderPlugin", "primitiveColorConvertGrayscaleMCU\000\002", (void*)primitiveColorConvertGrayscaleMCU},
	{"JPEGReaderPlugin", "primitiveColorConvertMCU\000\003", (void*)primitiveColorConvertMCU},
	{"JPEGReaderPlugin", "primitiveDecodeMCU\000\002", (void*)primitiveDecodeMCU},
	{"JPEGReaderPlugin", "primitiveIdctInt\000\001", (void*)primitiveIdctInt},

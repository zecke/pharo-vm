/* Automatically generated by
   ...
   from
	BitBltSimulation VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38
 */
static char __buildInfo[] = "BitBltSimulation VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"BitBltPlugin VMMaker.oscog-jeanbaptistearnaud.782 (i)"
#else
	"BitBltPlugin VMMaker.oscog-jeanbaptistearnaud.782 (e)"
#endif
;
...
{
	// BitBltSimulation>>#queryDestSurface:
	if (querySurfaceFn == 0) {
		if (!(loadSurfacePlugin())) {
			return 0;
		}
...
{
	// BitBltSimulation>>#querySourceSurface:
	if (querySurfaceFn == 0) {
		if (!(loadSurfacePlugin())) {
			return 0;
		}

/* Automatically generated by
   ...
   from
	ADPCMCodecPlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38
	ADPCMCodec Sound-GuillermoPolito.69 uuid: ab9cfd18-4610-4306-ae3d-5b258f0baed3
 */
static char __buildInfo[] = "ADPCMCodecPlugin VMMaker.oscog-jeanbaptistearnaud.782 uuid: 4529b9a2-dbec-4078-83aa-46de2ee4ed38\n\
ADPCMCodec Sound-GuillermoPolito.69 uuid: ab9cfd18-4610-4306-ae3d-5b258f0baed3 " __DATE__ ;
...
#ifdef SQUEAK_BUILTIN_PLUGIN
	"ADPCMCodecPlugin VMMaker.oscog-jeanbaptistearnaud.782 (i)"
#else
	"ADPCMCodecPlugin VMMaker.oscog-jeanbaptistearnaud.782 (e)"
#endif
;
		...
		if ((i & frameSizeMask) == 1) {
			...
			while (1) {
				...
				if (shift > 0) {
					...
					currentByte = currentByte & ((((bitPosition - 8) < 0) ? ((usqInt) 0xFF >> -(bitPosition - 8)) : ((usqInt) 0xFF << (bitPosition - 8))));
					predicted = result;
					goto l1;
				}
			}
